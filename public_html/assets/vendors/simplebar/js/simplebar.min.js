    ...
    !(function (t, e) {
        ...
        (Ci.prototype.clear = function () {
            ...
            (ji.prototype.delete = function (t) {
                ...
                return (
                    !(r < 0) &&
                    (r == e.length - 1 ? e.pop() : Ri.call(e, r, 1), !0)
                );
            }),
        ...
        (Vn || Xn) &&
            (Fn = function (t) {
                ...
                return (
                    ...
                    Vn &&
                        i &&
                        (o.lastIndex = o.global ? i.index + i[0].length : e),
                    Xn &&
                        i &&
                        i.length > 1 &&
        ...
        var Hn = Fn;
        At(
            { target: "RegExp", proto: !0, forced: /./.exec !== Hn },
            { exec: Hn }
        );
        var qn = jt("species"),
            $n = !c(function () {
            ...
            return [
                ...
                function (t) {
                    ...
                    for (var a, c = [], l = 0; null !== (a = Kn(n, o)); ) {
                        ...
                        (c[l] = u),
                            "" === u &&
                                (n.lastIndex = Qn(o, st(n.lastIndex), s)),
                            l++;
                    }
                    return 0 === l ? null : c;
                },
            ...
            (t.getRtlHelpers = function () {
                ...
                (t.getOffset = function (t) {
                    ...
                    return {
                        top:
                            e.top +
                            (i.pageYOffset || r.documentElement.scrollTop),
                        left:
                            e.left +
            ...
            return (
                ...
                (e.onDragStart = function (t, e) {
                    ...
                    (this.axis[e].dragOffset =
                        o - n.rect[this.axis[e].offsetAttr]),
                        (this.draggedAxis = e),
                ...
                (e.onTrackClick = function (t, e) {
                    var r = this;
                    if (
                        (void 0 === e && (e = "y"), this.options.clickOnTrack)
                    ) {
                        var i = no(this.el);
